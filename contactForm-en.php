...
<div class="row">
    ...
    <div class="col-md-9">
    <h2 id="title1">First Lean Summit for Spanish Speakers in Latin America</h2>
    </div>
</div>
</div>
<div id="contactDetails">
    ...
    <table class="table table-condensed">
        <tbody>
            <tr>
                <td class="flag"><a>English</a></td>
                <td><img src="images/usFlag.png" class="img-responsive" width="20px" alt="US flag"></td>
            </tr>
            <tr>
                <td class="flag"><a href="contactform.php">Español</a></td>
                <td><a href="contactForm.php"><img src="images/chileFlag.png" class="img-responsive" width="20px" alt="Chilean flag"></a></td>
            </tr>
        </tbody>
    </table>
</div>
...
<h2 id="title2">SUBSCRIPTIONS</h2>
    ...
    <div class="col-sm-12 col-md-6">
        <div class="form-group">
            <label for="rut">RUT / Passport No.</label>
    ...
    <div class="col-sm-12">
        <div class="form-group">
            <label for="asistente"><input type="checkbox" class="form-control" id="asistente" name="asistente" value='<?php echo $formproc->SafeDisplay('asistente') ?>'>ASSISTANT</label>
        </div>
        <p class="checkb">For more information, <a href="pdf/Ficha%20de%20Inscripcion%20Summit.pdf" download>download pdf</a></p>
        <p class="checkb">Fill the subscription and send the pdf to contacto@institutolean.cl</p>
        <div class="form-group">
            <label for="expositor"><input type="checkbox" class="form-control" id="expositor" name="expositor" value='<?php echo $formproc->SafeDisplay('expositor') ?>'>EXHIBITOR</label>
        </div>
        <p class="checkb">For more information, <a href="pdf/Informacio%CC%81n%20para%20Expositores_v1.pdf" download>download pdf</a></p>
        <p class="checkb">To send a presentation, <a href="pdf/Formato%20Presentacio%CC%81n%20Expositores_v1.pptx" download>download pptx</a></p>
        <div class="form-group">
            <label for="auspiciador"><input type="checkbox" class="form-control" id="auspiciador" name="auspiciador" value='<?php echo $formproc->SafeDisplay('auspiciador') ?>'>SPONSOR</label>
        </div>
        <p class="checkb">For more information, contact by email: ana.ulloa@institutolean.cl</p>
    </div>
    </div>
    <div class="col-sm-12">
        <div class="form-group">
    ...
    <div id="submitButton"><button id="submit" type="submit" name="Submit" value="Submit" class="btn btn-default">Send</button></div>
    </div>
    </div>
</div>
